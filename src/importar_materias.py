...
class ImportarMaterias(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Importar Materias CSV")
        ...
        if archivo:
            try:
                ...
                with open(archivo, newline='', encoding='utf-8') as f:
                    ...
                    for fila in lector:
                        cursor.execute("""
                            INSERT INTO Materia (sigla, nomb_materia, dia, hora, semestre)
                            VALUES (?, ?, ?, ?, ?)
                        """, (
                            fila['sigla'],
                            fila['nomb_materia'],
